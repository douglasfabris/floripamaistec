...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("companies", {
      ...
      neighbourhood: { type: Sequelize.STRING, allowNull: false },
      city: { type: Sequelize.STRING, allowNull: false },
      state: { type: Sequelize.STRING, allowNull: false },
      number: { type: Sequelize.STRING, allowNull: false },
      complement: { type: Sequelize.STRING, allowNull: false },
      rh_analyst_name: { type: Sequelize.STRING, allowNull: false },
      supervisor_name: { type: Sequelize.STRING, allowNull: false },
      created_at: {
        type: Sequelize.DATE,
        allowNull: false,
      },
